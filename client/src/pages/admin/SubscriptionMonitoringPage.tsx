...
const SubscriptionMonitoringPage: React.FC = () => {
  ...
  const fetchSubscriptionData = async () => {
    try {
      // This would be a new API endpoint for system admins
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Subscription Monitoring</h1>
          <p className="text-gray-600">Monitor all school subscriptions and revenue across the platform.</p>
        </div>
